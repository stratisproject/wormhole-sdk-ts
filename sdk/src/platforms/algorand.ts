import * as _algorand from "@xertraplatform/wormhole-sdk-algorand";
...
const algorand: PlatformDefinition<typeof _algorand._platform> = {
  ...
  protocols: {
    WormholeCore: () => import("@xertraplatform/wormhole-sdk-algorand-core"),
    TokenBridge: () => import("@xertraplatform/wormhole-sdk-algorand-tokenbridge"),
  },
