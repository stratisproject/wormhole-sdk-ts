...
import type { DynamicItemsOfLayout, LayoutToType } from "@xertraplatform/wormhole-sdk-base";
import { addFixedValues, serializeLayout } from "@xertraplatform/wormhole-sdk-base";
