import type { Chain, GatewayTransferDetails, Network, TokenId } from "@xertraplatform/wormhole-sdk";
import { GatewayTransfer, Wormhole, amount, wormhole } from "@xertraplatform/wormhole-sdk";
