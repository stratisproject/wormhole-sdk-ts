import type { Chain, GatewayTransferDetails, Network, TokenId } from "@xertra/wormhole-sdk";
import { GatewayTransfer, Wormhole, amount, wormhole } from "@xertra/wormhole-sdk";
